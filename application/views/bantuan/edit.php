                ...
                <div class="card-body">
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" name="nik" class="form-control" id="nik" aria-describedby="nik" value="<?= $detail->nik; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="umur" class="form-control" id="umur" aria-describedby="umur" value="<?= $detail->umur; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jumlah" class="form-control" id="jumlah" aria-describedby="jumlah" value="<?= $detail->jumlah; ?>">
